...
This guide provides comprehensive documentation for the **accessibility** skill in the custom-plugin-ux-design plugin.
...
```bash
# Invoke the skill
claude "accessibility - [your task description]"

# Example
claude "accessibility - analyze the current implementation"
```
...
def implement_accessibility(input_data):
    """
    Implement accessibility functionality.
