...
This guide provides comprehensive documentation for the **mobile-ux** skill in the custom-plugin-ux-design plugin.
...
```bash
# Invoke the skill
claude "mobile-ux - [your task description]"

# Example
claude "mobile-ux - analyze the current implementation"
```
...
def implement_mobile_ux(input_data):
    """
    Implement mobile-ux functionality.
