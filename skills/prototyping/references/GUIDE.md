...
This guide provides comprehensive documentation for the **prototyping** skill in the custom-plugin-ux-design plugin.
...
```bash
# Invoke the skill
claude "prototyping - [your task description]"

# Example
claude "prototyping - analyze the current implementation"
```
...
def implement_prototyping(input_data):
    """
    Implement prototyping functionality.
