...
This guide provides comprehensive documentation for the **ux-writing** skill in the custom-plugin-ux-design plugin.
...
```bash
# Invoke the skill
claude "ux-writing - [your task description]"

# Example
claude "ux-writing - analyze the current implementation"
```
...
def implement_ux_writing(input_data):
    """
    Implement ux-writing functionality.
